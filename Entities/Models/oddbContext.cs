...
{
    public partial class oddbContext : DbContext
    {
        public oddbContext()
        {
        }

        public oddbContext(DbContextOptions<oddbContext> options)
            : base(options)
        {
        }
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Server=(localdb)\\MSSQLLocalDB;Database=oddb;Trusted_Connection=True;");
            }
        }
